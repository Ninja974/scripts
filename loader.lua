...
local baseUrl = `https://raw.githubusercontent.com/Ninja974/scripts/refs/heads/main/{game.GameId}/{game.PlaceId}.lua`
local base64url = `https://api.github.com/repos/Ninja974/scripts/contents/{game.GameId}/{game.PlaceId}.lua?ref=main`
